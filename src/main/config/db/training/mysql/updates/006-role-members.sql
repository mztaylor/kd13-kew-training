...
INSERT INTO KRIM_ROLE_MBR_T(ROLE_MBR_ID, VER_NBR, OBJ_ID, ROLE_ID, MBR_ID, MBR_TYP_CD) 
	VALUES('KRTRN-CAMPUS-1', 1, UUID(), 'KRATRNG10002', 'dev1', 'P');
...
INSERT INTO KRIM_ROLE_MBR_T(ROLE_MBR_ID, VER_NBR, OBJ_ID, ROLE_ID, MBR_ID, MBR_TYP_CD) 
	VALUES('KRTRN-CAMPUS-2', 1, UUID(), 'KRATRNG10002', 'dev2', 'P');
...
INSERT INTO KRIM_ROLE_MBR_T(ROLE_MBR_ID, VER_NBR, OBJ_ID, ROLE_ID, MBR_ID, MBR_TYP_CD) 
	VALUES('KRTRN-CAMPUS-3', 1, UUID(), 'KRATRNG10002', 'idm1', 'P');

INSERT INTO KRIM_ROLE_MBR_ATTR_DATA_T(ATTR_DATA_ID, OBJ_ID, VER_NBR, ROLE_MBR_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) 
	VALUES('KRTRN-3-CAMPUS', UUID(), 1, 'KRTRN-CAMPUS-3', '17', '12', 'BA');
