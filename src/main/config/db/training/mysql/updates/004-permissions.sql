...
INSERT INTO KRIM_PERM_T(PERM_ID, NMSPC_CD, PERM_TMPL_ID, NM, DESC_TXT, ACTV_IND, OBJ_ID, VER_NBR)
  VALUES ('KRATRN-DEC_STATUS_PERM', 'KRA-TRNG', 57, 'Edit Decision Status Field', 'Permission to edit the Decision Status field', 'Y', UUID(), 1);
...
INSERT INTO KRIM_ROLE_PERM_T(ROLE_PERM_ID, ROLE_ID, PERM_ID, ACTV_IND, OBJ_ID, VER_NBR)
  VALUES ('KRATRN-DEC_STATUS', 'KRATRN-APVR_ROLE', 'KRATRN-DEC_STATUS_PERM', 'Y', UUID(), 1);
