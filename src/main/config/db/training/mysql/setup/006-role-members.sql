...
INSERT INTO KRIM_ROLE_MBR_T(ROLE_MBR_ID, VER_NBR, OBJ_ID, ROLE_ID, MBR_ID, MBR_TYP_CD)
  VALUES ('KRATRN-ADMN_ROLE-1', 1, UUID(), 'KRATRN-ADMN_ROLE', 'admin', 'P');

INSERT INTO KRIM_ROLE_MBR_T(ROLE_MBR_ID, VER_NBR, OBJ_ID, ROLE_ID, MBR_ID, MBR_TYP_CD)
  VALUES ('KRATRN-APVR_ROLE-1', 1, UUID(), 'KRATRN-APVR_ROLE', 'director', 'P');

INSERT INTO KRIM_ROLE_MBR_T(ROLE_MBR_ID, VER_NBR, OBJ_ID, ROLE_ID, MBR_ID, MBR_TYP_CD)
  VALUES ('KRATRN-RVWR_ROLE-1', 1, UUID(), 'KRATRN-RVWR_ROLE', 'doug', 'P');
