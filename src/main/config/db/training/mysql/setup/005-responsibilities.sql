...
INSERT INTO KRIM_RSP_T(RSP_ID, OBJ_ID, RSP_TMPL_ID, NMSPC_CD, NM, DESC_TXT, ACTV_IND)
    VALUES('KRTRN-0', UUID(), '1', 'KR-IDM', 'Initial Review Admissions Document', '', 'Y');

INSERT INTO KRIM_ROLE_RSP_T(ROLE_RSP_ID, OBJ_ID, ROLE_ID, RSP_ID, ACTV_IND) 
    VALUES('KRTRN-0-KRTRN-ADM_ROLE', UUID(), 'KRTRN-ADM_ROLE', 'KRTRN-0', 'Y');
    
INSERT INTO KRIM_RSP_ATTR_DATA_T(ATTR_DATA_ID, OBJ_ID, RSP_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) 
    VALUES('KRTRN-0-DOC', UUID(), 'KRTRN-0', '7', '13', 'AdmissionsWorkflowDocument');

INSERT INTO KRIM_RSP_ATTR_DATA_T(ATTR_DATA_ID, OBJ_ID, RSP_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) 
    VALUES('KRTRN-0-NODE', UUID(), 'KRTRN-0', '7', '16', 'InitialReview');

INSERT INTO KRIM_RSP_ATTR_DATA_T(ATTR_DATA_ID, OBJ_ID, RSP_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) 
    VALUES('KRTRN-0-REQ', UUID(), 'KRTRN-0', '7', '40', 'N');

INSERT INTO KRIM_RSP_ATTR_DATA_T(ATTR_DATA_ID, OBJ_ID, RSP_ID, KIM_TYP_ID, KIM_ATTR_DEFN_ID, ATTR_VAL) 
    VALUES('KRTRN-0-RML', UUID(), 'KRTRN-0', '7', '41', 'N');
